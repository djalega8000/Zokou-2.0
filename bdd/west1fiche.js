...
async function createWest1FicheTable() {
  const client = await pool.connect();

  try {
    // Créez la table west1_fiche si elle n'existe pas déjà
    await client.query(`
      CREATE TABLE IF NOT EXISTS west1_fiche(
    ...
    `);
    console.log('Table west1_fiche créée avec succès');
  } catch (error) {
    console.error('Erreur lors de la création de la table west1_fiche:', error);
  } finally {
    client.release();
  }
}
...
async function getR() {
  ...
  try {
    ...
    const query =
      "SELECT r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36 FROM west1_fiche";
