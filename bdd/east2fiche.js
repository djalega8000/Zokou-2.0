...
async function createEast2FicheTable() {
  const client = await pool.connect();

  try {
    // Créez la table east2_fiche si elle n'existe pas déjà
    await client.query(`
      CREATE TABLE IF NOT EXISTS east2_fiche(
...
async function getR() {
  ...
  try {
    ...
    const query =
      "SELECT r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36 FROM east2_fiche";
